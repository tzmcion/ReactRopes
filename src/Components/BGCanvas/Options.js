const default_options = {
    quantity: 25, //Quantity of blocks which build the line
    ...
    img_size_x: 50, //X size of the image
    img_size_y:50, // Y size of the image
    ...
    img_rotate_target_index:5, // Reference point which img rotation is based of, can be from range 0 to quantity-2
    color: "#aaa", //Color of the blocks creating the rope, try transparent ;)
    gravity:0.8, //Gravity strength, the higher the number, the gigher is gravity pulling down force per frame
    ...
    verlet_calculate_per_frame: 2,  // how many times vercel updates per frame, more means more calculations and more 'realism'
    verlet_target_distance:4, // what is the optimum distance between blocks in vercel calculations
    mouse_detect_distortion:1,  // hoe big is the radius of mouse interaction with the block, as strictly on the block might be difficult to achieve
